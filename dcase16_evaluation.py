...
# -*- coding: utf-8 -*-
"""
This file is taken without modifications from the DCASE2016 baseline system repository
It is used to get the same kind of evaluation metrics for comparison
Source: https://github.com/TUT-ARG/DCASE2016-baseline-system-python/blob/master/src/evaluation.py
No own author rights are imposed.
"""
